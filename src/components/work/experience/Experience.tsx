    ...
    <div className={styles.experience} ref={containerRef}>
      <div className={styles.introPanel}>
        <p>
          ...
          The summer before, I was a Research Assistant at the Institute for
          Politics and Strategy at Carnegie Mellon University, where I focused
          on historical research related to Coup D'etats.
        </p>
      </div>
    </div>
  );
