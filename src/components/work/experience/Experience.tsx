        ...
        <div className={styles.container}>
          ...
          <section className={styles.projects}>
            <article className={`${styles.project} ${styles.project1}`}>
              ...
              <div>
                <h3>2024 SUMMER</h3>
                <h2 className={styles.positionTitle}>Software Engineer Intern: Ford Motor Company</h2>
                <p>
                  At Ford, I embraced Test-Driven Development (TDD) and pair
                  programming to craft a dynamic React-based tool for Call
                  Center Agents, replacing an outdated system with a streamlined
                  search experience. Tackling a tricky 30-second timer glitch in
                  a Lean Coffee app was another highlight, where our
                  collaborative approach ensured a flawless user experience.
                  Mentoring new interns was a rewarding part of the summer,
                  where I guided them through a thoughtfully crafted onboarding
                  process, turning their first days into a smooth and productive
                  start.
                </p>
            ...
            <article className={`${styles.project} ${styles.project2}`}>
              <div>
                ...
                <p>
                  ...
                  Mellon's Institute for Politics and Strategy, I dove into the
                  complex world of self-coups and revolutionary events. I
                  cleaned and analyzed historical data, crafted detailed case
                  studies in LaTeX, and contributed to the Historical Dictionary
                  of Modern Self-Coups by creating bibliographic entries. A
                  highlight of my work was researching and writing about the
                  Castro brothers' self-coups, weaving their story into the
                  broader tapestry of political upheaval.
                </p>
                <p>Skills/tools I learned and developed:</p>
                <ul className={styles.techStack}>
                  <li>LaTex</li>
